...
import {iconClear} from "../../components/FullModal/images";
  ...
  render() {
    return (
      <div>
        ...
        <p>
          Battre ("us", "we", or "our") operates the https://battre.infizi.com
          website (the "Service").
        </p>
        ...
        <p>
          ...
          our Terms and Conditions, accessible from https://battre.infizi.com
        </p>
        ...
        <p>Battre uses the collected data for various purposes:</p>
        <ul>
        ...
        <p>
          Battre will take all steps reasonably necessary to ensure that your
        ...
        <p>
          Battre may disclose your Personal Data in the good faith belief that
          such action is necessary to:
        </p>
        <ul>
          <li>To comply with a legal obligation</li>
          <li>To protect and defend the rights or property of Battre</li>
          <li>
        ...
        <ul>
          <li>
            ...
            https://battre.infizi.com/contact
          </li>
        </ul>
      </div>
    );
...
const connectedPrivacyComponent = connect()(PrivacyComponent);
export {connectedPrivacyComponent as Privacy};
